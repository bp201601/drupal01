...
class __TwigTemplate_e6b0a94a597db263cb40b3342485c1e5e1032354d8e62dc01a010ddb6166d5c6 extends Twig_Template
{
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["attributes"] ?? null), "addClass", array(0 => "menu menu-parent"), "method"), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", array())) ? ("menu-item--active-trail active-trail") : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/danland/templates/menu.html.twig", "/var/www/html/drupal845/themes/danland/templates/menu.html.twig");
    }
}
